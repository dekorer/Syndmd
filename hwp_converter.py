...
def convert_hwp_to_hwpx(hwp_path: str, hwpx_path: str):
    """
    HWP 파일을 HWPX 파일로 변환합니다. (win32com 이용)
    """
    # HWP 경로가 유효한지 확인
...
def convert_hwpx_to_hwp(hwpx_path: str, hwp_path: str):
    """
    HWPX 파일을 HWP 파일로 변환합니다. (win32com 이용)
    """
